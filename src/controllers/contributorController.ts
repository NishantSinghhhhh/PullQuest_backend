...
//       const processedRepos: IRepository[] = [];
...
//    */
//   private async getRepositoryLanguages(owner: string, repo: string, accessToken: string): Promise<Record<string, number>> {
//     const octokit = new Octokit({
//       auth: accessToken,
//       userAgent: "PullQuest-Backend v1.0.0",
//     });
...
//       const issues = await this.searchGitHubIssues(
...
//       let issue = cachedIssues?.suggestedIssues.find(
